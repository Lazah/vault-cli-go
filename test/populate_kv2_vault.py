...
def create_customer_paths(cust_count:int):
    prefixes = ["serviceAccounts/local/","serviceAccounts/admin/","serviceAccounts/monitor/","serviceAccounts/audit/","serviceAccounts/orch/"]
    entries = []
...
def add_entry_names_to_customers(list:str):
    entries = []
...
def create_data_for_entries(entry_paths:list):
    ...
    for path in entry_paths:
        ...
        pws = []
        for num in range(0,max_entries):
